...
Expected: "/red-hat-logo-reverse-transparent-100px.png"
Received: "/red-hat-logo-default-transparent-36px.png"
Timeout:  5000ms

Call log:
  - Expect "toHaveAttribute" with timeout 5000ms
  - waiting for locator('.pf-v6-c-brand')
    9 × locator resolved to <img class="pf-v6-c-brand" alt="Red Hat build of Apicurio Registry" src="/red-hat-logo-default-transparent-36px.png"/>
      - unexpected value "/red-hat-logo-default-transparent-36px.png"
    ...
    - generic [ref=e46]:
      ...
      - generic [ref=e80]:
        ...
        - generic [ref=e85]:
          - generic [ref=e86]:
            - img [ref=e88]
            - heading "No recent artifacts" [level=5] [ref=e91]
          - generic [ref=e92]: No recent artifacts found. Create your first artifact to get started.
      - generic [ref=e94]:
        - generic [ref=e96]: Quick Actions
        - generic [ref=e98]:
          - button "Create Artifact" [ref=e100] [cursor=pointer]:
            - img [ref=e102]
            - generic [ref=e104]: Create Artifact
          - button "Search Registry" [ref=e106] [cursor=pointer]:
            - img [ref=e108]
            - generic [ref=e110]: Search Registry
          - button "Explore Groups" [ref=e112] [cursor=pointer]:
            - img [ref=e114]
            - generic [ref=e116]: Explore Groups
...
```ts
  ...
  6  | const EXPECTED_LOGO_SRC: string = process.env["EXPECTED_LOGO_SRC"] || (IS_DOWNSTREAM ? "/red-hat-logo-reverse-transparent-100px.png" : "/apicurio_registry_logo_default.svg");
  7  | 
